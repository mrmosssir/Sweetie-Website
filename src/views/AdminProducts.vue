  ...
  <div class="container" v-if="!returnLoading">
    ...
    <div class="row">
      ...
      <div class="col-md-2 text-right">
        <button type="button" class="btn btn-brown" @click.prevent="openModal()">新增產品</button>
      </div>
    </div>
    <table class="table table-borderless mt-4 bg-white border border-brown border-bottom-0">
      ...
      <tbody class="text-secondary">
        <tr class="border border-brown border-bottom" v-for="item in returnProducts" :key="item.id">
          ...
          <td class="text-center">
            <button class="btn btn-sm btn-outline-brown rounded" @click="openModal(false, item)">
              編輯
            </button>
          </td>
        </tr>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
              ...
              <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label for="customFile"
                    >或 上傳圖片
                    <i class="fas fa-spinner fa-spin text-brown" v-if="returnUpdateStatus"> </i>
                  </label>
                  <input
                    type="file"
                    id="customFile"
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-brown" @click.prevent="submitProduct">送出</button>
            <button class="btn btn-danger" v-if="!returnIsNew" @click.prevent="deleteProduct()">
              刪除
            </button>
          </div>
        </div>
